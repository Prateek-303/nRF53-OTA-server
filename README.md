...
│          │                                                                  │
│          ▼                                                                  │
│  4. Download firmware (.bin) in 1 KB chunks                                │
│          │                                                                  │
│          ▼                                                                  │
│  5. Verify CRC-32 while downloading                                         │
│          │                                                                  │
│          ▼                                                                  │
│  6. Verify final SHA-256 hash                                               │
│          │                                                                  │
│          ▼                                                                  │
│  7. MCUboot Image Swap                                                      │
│          │                                                                  │
│          ▼                                                                  │
│  8. Reboot → New Firmware Running ✓                                         │
│                                                                             │
└─────────────────────────────────────────────────────────────────────────────┘
```
...
PATCHLEVEL = 1          ← Patch: bug fixes, pin corrections
```
